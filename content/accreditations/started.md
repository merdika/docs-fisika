...
Tab Indikator Skor 0 ini akan memberikan keterangan (Indikator) dari masing-masing Kriteria yang disertai dengan Tombol Action (...), fungsi dari Tombol Action (...) ini adalah untuk masuk ke Halaman Indikator dengan cara mengklik menu Detail yang telah diberikan oleh Tombol Action (...).
